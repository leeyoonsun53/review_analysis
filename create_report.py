...
def main():
    ...
    add_content_slide(prs, "분석 개요", [
        ...
        f"▶ 긍정률 1위: 토니모리 (93.5%)",
        f"▶ 가장 많은 Pain Point: 건조함 (134건)",
        f"▶ 가장 많은 Positive Point: 촉촉함 (3,312건)",
    ...
    # 브랜드별 TOP Positive/Pain
    brand_analysis = {
        '토리든': {'pos': ['촉촉함 (1,223)', '순함 (669)', '재구매 의사 (426)'],
                  'pain': ['건조함 (48)', '속건조 (17)', '재구매 의사 없음 (16)']},
        '브링그린': {'pos': ['진정 효과 (441)', '재구매 의사 (300)', '촉촉함 (274)'],
                    'pain': ['자극 (48)', '건조함 (37)', '눈에 들어가면 따가움 (27)']},
        '독도토너': {'pos': ['순함 (381)', '촉촉함 (331)', '순하다 (205)'],
                    'pain': ['건조함 (14)', '수분감 부족 (9)', '보습 부족 (6)']},
        '에스네이처': {'pos': ['촉촉함 (519)', '순함 (215)', '재구매 의사 (163)'],
                      'pain': ['눈에 들어가면 따가움 (13)', '자극 (7)', '수분감 부족 (5)']},
        '아누아': {'pos': ['촉촉함 (277)', '순함 (226)', '진정 효과 (154)'],
                  'pain': ['가격이 비쌈 (17)', '건조함 (16)', '비싼 가격 (14)']},
        '토니모리': {'pos': ['촉촉함 (450)', '대용량 (210)', '가성비 (189)'],
                    'pain': ['냄새 (8)', '자극 (6)', '건조함 (6)']},
        '아비브': {'pos': ['촉촉함 (238)', '진정 효과 (173)', '순함 (152)'],
                  'pain': ['냄새 (13)', '건조함 (8)', '효과 없음 (8)']},
    }
    ...
    add_insight_slide(prs, "브랜드 전략 제언", [
        "① 토리든: 점유율 1위(30%) 유지. 최근 긍정률 하락(92→89%) 모니터링 필요. '건조함' 불만 개선 시급",
        "② 브링그린: 진정 효과 강점 유지. '자극' 불만 해소로 민감성 시장 확대 가능",
        "③ 독도토너: 보습/진정 균형형 포지셔닝이 강점. 무신사 채널 확대 기회",
        "④ 아누아: '가격이 비쌈' 불만 1위. 가격 정책 또는 가치 커뮤니케이션 재검토",
        "⑤ 토니모리: 가성비 리더(39.3%). 쫀쫀한 제형 차별화 유지하며 프리미엄 라인 고려",
    ])

    add_insight_slide(prs, "채널 & 제품 제언", [
        "① 무신사 채널: 긍정률 95.5%로 올리브영(89.7%) 대비 월등. 채널 확대 검토",
        "② 대용량 마케팅: '대용량', '가성비'가 주요 구매 동인. 용량 다변화 전략",
        "③ 사용법 교육: 닦토(31.7%), 레이어링(14.9%) 중심 콘텐츠 강화",
        "④ 공통 Pain Point: '건조함'(134건), '자극'(89건) - 민감성 소구 강화 필요",
        "⑤ 텍스처 차별화: 대부분 '물같음' 포지셔닝. 쫀쫀/크리미 라인으로 차별화 기회",
    ])

    # ========== 9. 부록 ==========
    add_section_slide(prs, "부록: 상세 데이터")

    # 전체 Pain Points TOP 10
    pain_data = [
        ['건조함', '134', '모든 브랜드'],
        ['자극', '89', '브링그린, 아누아'],
        ['눈에 들어가면 따가움', '62', '브링그린, 에스네이처'],
        ['보습 부족', '53', '토리든, 독도토너'],
        ['가격이 비쌈', '50', '아누아'],
        ['수분감 부족', '48', '독도토너, 에스네이처'],
        ['진정 효과 부족', '44', '아누아, 아비브'],
        ['효과 부족', '43', '독도토너, 아비브'],
        ['냄새', '38', '토니모리, 아비브'],
        ['재구매 의사 없음', '38', '토리든'],
    ...
    # 전체 Positive Points TOP 10
    pos_data = [
        ['촉촉함', '3,312', '토리든, 에스네이처, 토니모리'],
        ['순함', '1,958', '토리든, 독도토너, 아누아'],
        ['재구매 의사', '1,405', '토리든, 브링그린'],
        ['진정 효과', '956', '브링그린, 아비브'],
        ['자극 없음', '943', '토리든, 독도토너'],
        ['대용량', '896', '토리든, 브링그린, 토니모리'],
        ['순하다', '864', '독도토너, 아누아'],
        ['가성비', '613', '토니모리, 브링그린'],
        ['추천', '577', '전체'],
        ['수분감', '539', '에스네이처'],
